...
seed16 = pandas.read_csv("Test/Reduced2/seed16/test_Euskera.csv",header=0,index_col=0)
...
seed44 = pandas.read_csv("Test/Reduced2/seed44/test_Euskera.csv",header=0,index_col=0)
for language in lang:
    for task in tasks:
        for metric in metrics:
            key = metric + " " + task
...
seed85 = pandas.read_csv("Test/Reduced2/seed85/test_Euskera.csv",header=0,index_col=0)
for language in lang:
    for task in tasks:
        for metric in metrics:
            key = metric + " " + task
